...
Uses the SentimentAnalysisPipeline class from Sentiment_analysis project
"""

import logging
from config import settings
from services.sentiment_service.sentiment_pipeline import SentimentAnalysisPipeline  
